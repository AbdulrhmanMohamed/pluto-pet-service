...
function Notifications() {
  ...
  return (
    <Layout>
      <div className="notifications p-5 bg-white m-0">
        <h2 className="page-title">Notifications</h2>
        <Tabs>
          <Tabs.TabPane key={0} tab="UnSeen">
            ...
            {user &&
              user?.unSeenNotification.map((noti, index) => {
                return (
                  <div
                    key={index}
                    class="card p-3 my-2"
          ...
          <Tabs.TabPane key={1} tab="Seen">
            ...
            {user &&
              user?.seenNotification.map((noti, index) => {
                return (
                  <div
                    key={index}
                    class="card p-3 my-2"
