  ...
  return (
    <div className="card my-5"
            ...
            <div className="" style={{background:'#FFF6E6',padding:'0px 30px',borderRadius:'6px',border:'2px solid #f1f1f1'}}>
                <h4 style={{color:'var(--soDarkColor)'}}> <span style={{color:'#777'}}> </span>{
                    service.firstName
                }&nbsp; {
                    service.lastName
                }</h4>
            ...
            <div className="card-body p-0 my-2">
               <div className="flexservice d-flex align-items-center justify-content-center py-3">
               <img src={
                        generateRandomImage()
                    }
                    className='w-50'
                ...
                <div className="">
                    <div className="icon-wrapper d-flex align-items-center justify-content-around">
                        {
                        service.whatsApp && <i class="fa-brands fa-whatsapp  fa-3x"></i>
                    }
                        {
                        service.facebook && <i class="fa-brands fa-firefox-browser fa-3x "></i>
                    }
                        {
                        service.email && <i class="fa-solid fa-envelope fa-3x"></i>
                    } </div>
